...
public class BairroController {
	...
	@PostMapping("/procurarBairroPorNome")
	public String procurarBairroPorNome(String nomeBairro, Model model) {
		List<Bairro> bairros = bairroService.listarPorNome(nomeBairro);			
		model.addAttribute("bairros", bairros);		
		return "listarBairros";		
	}
